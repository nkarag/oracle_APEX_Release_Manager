...
--   Date and Time:   16:14 Thursday February 11, 2010
--   Exported By:     ADMIN
--   Flashback:       0
...
wwv_flow_api.create_flow(
  ...
  p_checksum_salt_last_reset => '20100211161455',
  ...
  p_last_upd_yyyymmddhh24miss=> '20100211161455',
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20100211153517',
...
s:=s||'J_ID:''||a.OBJ_ID||''"> <img src="#IMAGE_PREFIX#edit-white.gif" alt="Edit"> </a>'''||chr(10)||
'    when b.FORM_ID IS NULL then ''N/A'''||chr(10)||
'    else ''<a style="color: blue" href="http://10.101.1.27:8666/bugzilla/show_bug.cgi?id=''||to_char(e.BUGZILLA_ID)||''">''||to_char(e.BUGZILLA_ID)||''</a>'' '||chr(10)||
' end as BUGZILLA_ID   '||chr(10)||
',APEX_ITEM.TEXTAREA(2,a.change_details,5,80) CHANGE_DETAILS'||chr(10)||
'from RMGR.RLSMGR_FORMCHANGESOBJS a join RMGR.R';

s:=s||'LSMGR_OBJECTS b on (a.OBJ_ID = b.OBJ_ID)join RMGR.RLSMGR_AREAS  c on (b.OBJ_AREA_ID = c.AREA_ID)'||chr(10)||
...
s:=s||'_ID = decode(nvl(:P2_OBJ_TYPE_SRCH,-999), -999, b.OBJ_TYPE_ID, :P2_OBJ_TYPE_SRCH)'||chr(10)||
...
'from RMGR.RLSMGR_FORMCHANGESOBJS a join  RMGR.RLSMGR_OBJECTS b on (a.OBJ_ID = b.OBJ_ID)join RMGR.RLSMGR_AREAS  c on (b.OBJ_AREA_ID = c.AREA_ID';
...
wwv_flow_api.create_page_item(
  ...
  p_post_element_text=>' <a href="http://10.101.1.27:8666/bugzilla/show_bug.cgi?id=&P2_BUGZILLA_ID."> GO TO &P2_BUGZILLA_ID.</a> ',
...
wwv_flow_api.create_page_item(
  ...
  p_post_element_text=>' <a href="http://10.101.1.27:8666/bugzilla/show_bug.cgi?id=&P2_RM_BUGZILLA_ID."> GO TO &P2_RM_BUGZILLA_ID.</a> ',
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20100126172258',
  p_page_is_public_y_n=> 'N',
  p_page_comment  => '');
...
s:=s||'GE_PREFIX#edit-white.gif" alt="Edit"> </a>'''||chr(10)||
'    else ''<a style="color: blue" href="http://10.101.1.27:8666/bugzilla/show_bug.cgi?id=''||to_char(d.BUGZILLA_ID)||''">''||to_char(d.BUGZILLA_ID)||''</a>'' '||chr(10)||
' end as BUGZILLA_ID   '||chr(10)||
...
'left outer join RMGR.RLSMGR_FORMS d on';

s:=s||' (a.FORM_ID = d.FORM_ID)'||chr(10)||
'where'||chr(10)||
'b.AREA_ID in ('||chr(10)||
...
'   where FORM_ID = :P2_FORM_ID'||chr(10)||
')'||chr(10)||
'AND a.OBJ_DESC LIKE nvl(:P4_OBJ_DESC_SRCH,a.OBJ_D';
